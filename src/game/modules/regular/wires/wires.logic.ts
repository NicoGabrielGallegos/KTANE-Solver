...
import type { Wire, WiresSolution } from "./wires.types.ts";
import { countBlack, countBlue, countRed, countWhite, countYellow, hasBlackAt, hasYellowAt, matchColors } from "./wires.utils.ts";

export function solveWires(wires: Wire[], edgework: BombEdgework): WiresSolution {
    switch (wires.length) {
        case 3:
...
export function solveWires3(wires: Wire[]): WiresSolution {
...
export function solveWires4(wires: Wire[], edgework: BombEdgework): WiresSolution {
...
export function solveWires5(wires: Wire[], edgework: BombEdgework): WiresSolution {
    const { serial } = edgework
...
export function solveWires6(wires: Wire[], edgework: BombEdgework): WiresSolution {
    const { serial } = edgework
